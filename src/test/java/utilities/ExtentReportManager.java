        ...
        if (Desktop.isDesktopSupported()) {
           ...
           /* try
            ...
            //Create the email message ImageHTMLEmail =new ImageHtmlEmail();
            	...
            	email.setAuthenticator(new DefaultAuthenticator("praveenkumar7373.m@gmail.com", "password"));
            	email.setSSLOnConnect(true); 
            	email.setFrom("praveenkumar7373.m@gmail.com");
            	
            	//Sender email.setSubject(""Test Results);
            	
            	email.setMsg("Please find Attached Report...");
            	email.addTo("praveenkumar7373.m@gmail.com"); //Recceiver
